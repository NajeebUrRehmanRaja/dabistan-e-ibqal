...
const sections = [
    { title: "Biography", href: "/figures/quaid-e-azam/biography" },
    { title: "PDF Downloads", href: "/figures/quaid-e-azam/pdfs" },
    { title: "Quotes", href: "/figures/quaid-e-azam/quotes" },
    { title: "Gallery", href: "/figures/quaid-e-azam/gallery" },
];

export default function QuaidEAzamPage() {
    return (
            ...
            <div className="container mx-auto px-4 max-w-7xl relative z-10">
                ...
                <div className="text-center mb-12 space-y-3">
                    ...
                    <p className="text-white/90 text-lg pt-2 max-w-3xl mx-auto">
                        Explore the life, legacy, and vision of the Father of the Nation
                    </p>
                </div>
