...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        label: "Maulana Rumi",
        href: "/personalities/molana-rumi",
        children: [
          { label: "Biography", href: "/personalities/molana-rumi/biography" },
          { label: "PDF", href: "/personalities/molana-rumi/pdfs" },
          { label: "Quotes from Biography", href: "/personalities/molana-rumi/quotes" },
          { label: "Kalam (Performative)", href: "/personalities/molana-rumi/kalam/performative" },
          { label: "Kalam (Recitation)", href: "/personalities/molana-rumi/kalam/recitation" },
        ],
      },
    ],
  },
