    ...
    children: [
      {
        ...
        children: [
          ...
          { label: "Books", href: "/figures/molana-rumi/books" },
          { label: "Quotes", href: "/figures/molana-rumi/quotes" },
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Books", href: "/figures/allama-iqbal/books" },
          { label: "Quotes", href: "/figures/allama-iqbal/quotes" },
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Books", href: "/figures/quaid-e-azam/books" },
          { label: "Quotes", href: "/figures/quaid-e-azam/quotes" },
          { label: "Gallery", href: "/figures/quaid-e-azam/gallery" },
        ],
      },
      {
        label: "Javid Iqbal",
        href: "/figures/javid-iqbal",
        children: [
          { label: "Biography", href: "/figures/javid-iqbal/biography" },
          { label: "Books", href: "/figures/javid-iqbal/books" },
          { label: "Quotes", href: "/figures/javid-iqbal/quotes" },
          { label: "Gallery", href: "/figures/javid-iqbal/gallery" },
        ],
      },
    ],
  },
